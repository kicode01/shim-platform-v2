      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-8">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-xl bg-zinc-900 flex items-center justify-center text-white font-bold text-lg shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <button 
              ...
              className="flex items-center gap-1.5 text-xs font-medium bg-zinc-900 text-white px-3 py-1.5 rounded-full hover:bg-zinc-800 transition-colors shadow-sm"
            >
              <QrCode size={12} />
              My QR Code
            </button>
        ...
        >
          {[
            { label: "Certificates", value: stats.totalCertificates, color: "text-zinc-900" },
            { label: "Events Attended", value: stats.eventsAttended, color: "text-zinc-900" },
            { label: "Organizations", value: stats.organizations, color: "text-zinc-900" },
        ...
        >
          ...
          <div className="bg-white border border-zinc-200 rounded-xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-zinc-900">Trusted Organizations</h3>
            </div>
          ...
          <div className="bg-white border border-zinc-200 rounded-xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-zinc-900">Events Attended</h3>
            </div>
            ...
            {certificates.map((cert, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-zinc-900">{cert.role} Certificate</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2 flex-wrap">
                      <p className="text-sm font-semibold text-zinc-900">Participant Certificate</p>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-100">
                <h3 className="font-semibold text-zinc-900">My QR Code</h3>
              ...
              <div className="p-8 flex flex-col items-center">
                ...
                <p className="font-mono text-zinc-900 font-bold text-lg tracking-wider bg-zinc-100 px-4 py-2 rounded-lg mt-4">
                  #{user.membershipId}
                </p>
              </div>
            </div>
