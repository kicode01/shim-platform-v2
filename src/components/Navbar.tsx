                ...
                <AnimatePresence mode="wait">
                  ...
                  {isDashboardMode && (
                    <motion.span 
                      ...
                      exit={{ opacity: 0, x: -10 }}
                      transition={{ duration: 0.3 }}
                      className="text-zinc-700 text-2xl font-black tracking-[-0.08em] lowercase leading-none"
                      style={{ fontFamily: 'var(--font-inter), system-ui, sans-serif' }}
                    >
                      .organizer
                    </motion.span>
            ...
            {isMounted && (
              <AnimatePresence mode="wait">
                ...
                >
                  {!isAuthPage && (
                    <>
                      <Link href="/validate" className="text-sm font-medium text-zinc-100 hover:text-white transition-colors flex items-center gap-1.5 bg-zinc-700 border border-zinc-700 rounded-md px-3 py-1.5 hover:border-zinc-700 whitespace-nowrap shadow-sm">
                        Verify
                      </Link>
                      <div className="h-5 w-px bg-zinc-700 shrink-0 hidden sm:block"></div>
                      ...
                      <Link href="/register" className="bg-zinc-100 hover:bg-white text-zinc-700 transition-colors text-sm font-medium rounded-md px-4 py-2 flex items-center gap-2 whitespace-nowrap shadow-sm">
                        Get Started
                ...
                >
                  {session?.user ? (
                    (session.user as any).role === "member" ? (
                      <Link 
                        href="/portal"
                        className="flex items-center gap-2 bg-white border border-zinc-200 text-zinc-700 hover:bg-zinc-50 hover:text-zinc-700 px-4 py-2 rounded-md font-medium text-sm transition-colors shadow-sm"
                      >
                    ...
                    <div className="flex items-center gap-6">
                      <Link href="/" className="text-sm font-medium text-zinc-500 hover:text-zinc-700 transition-colors whitespace-nowrap">
                        Home
                      </Link>
                      <Link href="/login" className="flex items-center justify-center bg-zinc-700 border border-zinc-700 hover:bg-zinc-700 text-zinc-100 hover:text-white transition-colors rounded-md px-4 py-2 shadow-sm text-sm font-medium whitespace-nowrap">
                        Sign In
                      </Link>
                    </div>
                  )}
