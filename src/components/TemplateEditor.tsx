  ...
  return (
    <div className="flex-1 flex flex-col max-w-7xl mx-auto w-full px-4 sm:px-8 py-6 min-h-0 overflow-hidden">
      ...
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 mb-6 shrink-0">
        <div>
          <Link href="/dashboard/templates" className="inline-flex items-center gap-2 text-sm font-medium text-zinc-500 hover:text-zinc-900 transition-colors mb-4">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-0 overflow-hidden">
        ...
        <div className="lg:col-span-4 flex flex-col bg-white border border-zinc-200 rounded-xl overflow-hidden shadow-sm">
          <div className="flex border-b border-zinc-200 shrink-0 p-2 bg-zinc-50/50 gap-2">
            <button className={`flex-1 py-2.5 rounded-md text-sm font-medium flex items-center justify-center gap-2 transition-all ${activeTab === "builder" ? "bg-white text-zinc-900 shadow-sm ring-1 ring-zinc-200" : "text-zinc-600 hover:bg-zinc-100/80 hover:text-zinc-900"}`} onClick={() => setActiveTab("builder")}>
              <Move size={16} /> Builder
            </button>
            <button className={`flex-1 py-2.5 rounded-md text-sm font-medium flex items-center justify-center gap-2 transition-all ${activeTab === "json" ? "bg-white text-zinc-900 shadow-sm ring-1 ring-zinc-200" : "text-zinc-600 hover:bg-zinc-100/80 hover:text-zinc-900"}`} onClick={() => setActiveTab("json")}>
              <Code2 size={16} /> JSON
            </button>
          </div>
            ...
            <AnimatePresence mode="wait">
              ...
              {activeTab === "builder" ? (
                ...
                <div className="bg-zinc-50 border border-zinc-200 rounded-xl p-5 space-y-4">
                  <h4 className="text-sm font-semibold text-zinc-900 border-b border-zinc-200 pb-2 mb-3 flex items-center justify-between">
                    Canvas Background
                  </h4>
                      ...
                      <>
                        ...
                        <div className="flex gap-2">
                          <div className="flex border border-zinc-200 rounded-lg bg-white overflow-hidden shadow-sm">
                            <button className={`p-2 transition-colors ${selectedElement.align === 'left' ? 'bg-zinc-100 text-zinc-900' : 'text-zinc-500 hover:bg-zinc-50'}`} onClick={() => updateSelectedElement({ align: 'left' })}><AlignLeft size={16} /></button>
                            <div className="w-px bg-zinc-200"></div>
                            <button className={`p-2 transition-colors ${selectedElement.align === 'center' ? 'bg-zinc-100 text-zinc-900' : 'text-zinc-500 hover:bg-zinc-50'}`} onClick={() => updateSelectedElement({ align: 'center' })}><AlignCenter size={16} /></button>
                            <div className="w-px bg-zinc-200"></div>
                            <button className={`p-2 transition-colors ${selectedElement.align === 'right' ? 'bg-zinc-100 text-zinc-900' : 'text-zinc-500 hover:bg-zinc-50'}`} onClick={() => updateSelectedElement({ align: 'right' })}><AlignRight size={16} /></button>
                          </div>
                          <div className="flex border border-zinc-200 rounded-lg bg-white overflow-hidden shadow-sm">
                            <button className={`p-2 transition-colors ${selectedElement.fontWeight === 'bold' ? 'bg-zinc-100 text-zinc-900' : 'text-zinc-500 hover:bg-zinc-50'}`} onClick={() => updateSelectedElement({ fontWeight: selectedElement.fontWeight === 'bold' ? 'normal' : 'bold' })}><Bold size={16} /></button>
                            <div className="w-px bg-zinc-200"></div>
                            <button className={`p-2 transition-colors ${selectedElement.fontStyle === 'italic' ? 'bg-zinc-100 text-zinc-900' : 'text-zinc-500 hover:bg-zinc-50'}`} onClick={() => updateSelectedElement({ fontStyle: selectedElement.fontStyle === 'italic' ? 'normal' : 'italic' })}><Italic size={16} /></button>
                          </div>
                        </div>
                      </>
                    )}
